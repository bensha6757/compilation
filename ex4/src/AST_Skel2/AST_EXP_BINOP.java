...
public class AST_EXP_BINOP extends AST.AST_EXP
{
	int OP;
	public AST.AST_EXP left;
	public AST.AST_EXP right;
	
	/******************/
	/* CONSTRUCTOR(S) */
	/******************/
	public AST_EXP_BINOP(AST.AST_EXP left, AST_EXP right, int OP)
	{
		/******************************/
	...
	public void PrintMe()
	{
		...
		/****************************************/
		if (left  != null) AST.AST_GRAPHVIZ.getInstance().logEdge(SerialNumber,left.SerialNumber);
